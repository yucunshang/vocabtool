...
AI_CARD_EXAMPLE_COUNT_MAX = 2
AI_CARD_EXAMPLE_COUNT_DEFAULT = 1
DEEPSEEK_BASE_URL_DEFAULT = "https://api.deepseek.com"
DEEPSEEK_CHAT_MODEL_DEFAULT = "deepseek-v4-flash"
DEEPSEEK_CHAT_MODEL_REQUIRED_PREFIX = "deepseek-v4-flash"
DEEPSEEK_CHAT_MODEL_BLOCKED_FRAGMENT = "pro"
DEEPSEEK_CHAT_HISTORY_LIMIT = 20
MAX_RETRIES = 3
...
VOCAB_PROJECT_FILE = "ngsl_31k.csv"
